...
public class RabbitAI extends AbstractAI {
     ...
     * @param animal the animal to do the search for
     ...
     * @param world the world
     * @param animal the animal to do the search for
     * @return a good location to put the child in and null if no such location exists
     */
     ...
     * 
     * @param safeDirections the safe directions
     * @param emptyDirections the empty directions
